...
const bancoDeDadosVagas = [
  new VagaFrontEnd(
    ...
    ["JavaScript", "Github", "Lógica de Programação", "TypeScript"],
    2800,
    "Remoto",
    "Júnior",
  ),
  new VagaFrontEnd(
    "CodeLab",
    "Front-End",
    ["JavaScript", "React", "Github", "Kanban"],
    1800,
    "Híbrido",
    "Estágio",
  ),
  new VagaFrontEnd(
    ...
    ["JavaScript", "Arrays", "Objeto", "Funções", "Html"],
    3000,
    "Presencial",
    "Júnior",
  ),
...
function exibirMensagemFinal(nome) {
  console.log(
    `${nome}, como sugestão analise as habilidades faltantes para uma próxima entrevista estar mais preparada.`,
  );
}
...
async function iniciarSistema() {
  ...
  for (const itemVaga of listaDeVagas) {
    ...
    switch (true) {
      case porcentagem >= 80:
        console.log(
          "Classificação: Você possui alta compatibilidade com a vaga.",
        );
        break;
      case porcentagem >= 50:
        console.log(
          "Classificação: Você possui média compatibilidade com a vaga.",
        );
        break;
      default:
        console.log(
          "Classificação: Você possui baixa compatibilidade com a vaga.",
        );
    }
  ...
  console.log(
    `Priorize estudar ${habilidadesSemRepeticao.join(", ")}, pois esses conteúdos aparecem nas vagas analisadas.`,
  );
  console.log(
    "................................................................\n",
  );
